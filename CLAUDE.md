...
- **Weekly deficit trend** (report this as a 4-week table): W27 411 → W28 479 → W29 513 → W30 651 → W31 160 → W32 447 → **W33 705** cal/day. Cut-to-date average 481/day, which predicts 0.96 lb/wk and matches the observed 1.0 lb/wk — the model is calibrated.
- **Weekend pattern (as of 2026-08-24): SOLVED for Fri/Sat.** Fri 8/21 (2,220) and Sat 8/22 (1,868) both hit target — the Friday blowouts that stalled the first month are broken. The remaining miss moved to **Sunday** (8/23 at 3,540). Watch that Sunday doesn't become the new Friday. Report every over-target day straight against the 2,000 target — he does not believe in cheat days and does not want date nights graded on a curve.
